...
const carInfo = function(num, year, type) {
...
//     let mappedModel = {};
//     mappedModel.car_model = inventory[i].car_model;
//     carModels.push(mappedModel);
//     mappedModel = {};
// }
...
for(let i = 0; i < inventory.length; i++) {
    let mappedYear = {};
    mappedYear.car_year = inventory[i].car_year;
    carYears.push(mappedYear);
    mappedYear = {};
}
